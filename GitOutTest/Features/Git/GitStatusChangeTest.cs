...
namespace GitOut.Features.Git
{
    public class GitStatusChangeTest
    {
        ...
        {
            string line = "u UU N... 100644 100644 100644 100644 039e0a7cc1b30b61b9ed15f627fbe1bc3ec356b0 9e8f761788fd8307e582e0402828237176e645e3 26bfbac95f8721b022a70c2cd07ca4bc18edb5ff advanced.txt";
            GitStatusChange change = GitStatusChange.Parse(line).Build();

            Assert.That(change.Type, Is.EqualTo(GitStatusChangeType.Unmerged));
            Assert.That(change.WorkspaceStatus, Is.EqualTo(GitModifiedStatusType.UpdatedButUnmerged));
        ...
        {
            string line = "u DU N... 100644 000000 100644 100644 db1eb37c1e082b97991496dce075552e08b09daf 0000000000000000000000000000000000000000 d5aa6d9ec26d2c0cc6a0d0a6f10926529dad4882 appc.json";
            GitStatusChange change = GitStatusChange.Parse(line).Build();
