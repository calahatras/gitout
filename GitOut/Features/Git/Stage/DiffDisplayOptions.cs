...
namespace GitOut.Features.Git.Stage
{
    ...
    {
        public DiffDisplayOptions(double pixelsPerDip, Brush dividerBrush, Brush headerForeground, ITextTransform transform)
        {
        ...
        public DiffDisplayOptions(double pixelsPerDip, Brush dividerBrush, Brush headerForeground) : this(pixelsPerDip, dividerBrush, headerForeground, new PassThroughTransform()) { }
